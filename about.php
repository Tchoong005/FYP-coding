...
<head>
  ...
  <style>
    ...
    .about-hero { padding: 50px; background: #fff0f0; text-align: center; }
    .about-hero h1 { font-size: 42px; color: #d6001c; }
    .about-hero p { font-size: 18px; margin-top: 10px; color: #444; max-width: 700px; margin-left: auto; margin-right: auto; }
    .about-section { display: flex; flex-wrap: wrap; justify-content: center; align-items: center; gap: 40px; padding: 40px; }
    .about-section img { width: 400px; border-radius: 16px; }
    .about-section .text { max-width: 500px; font-size: 16px; line-height: 1.6; }
...
<div class="about-section">
  ...
  <div class="text" data-aos="fade-left">
    ...
    <p>
      Our mission is simple: deliver happiness through every bite. Whether it's a classic cheeseburger or crispy fried chicken, we guarantee flavor in every order!
    </p>
  </div>
</div>
