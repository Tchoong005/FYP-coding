    ...
    <div class="nav-links">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="products_guest.php" class="active-link">Products</a>
                <a href="order_trace.">Order Trace</a>
...
<div class="container">
    ...
    <div class="search-bar">
        <form method="GET" action="products_guest.php">
