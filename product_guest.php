...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Top navigation bar styles - 与首页一致 */
    .topbar {
...
<div class="header-section" data-aos="fade-down">
  <h2><i class="fas fa-utensils"></i> Browse Our Menu</h2>
  <p>Explore our delicious selection of fast food favorites. Sign in to place an order.</p>
</div>
          ...
          foreach ($products as $product) {
              ...
              echo '
                  <div class="product-card" data-aos="fade-up">
                      ...
                      <button class="' . $button_class . '" data-page="Add to Cart">' . $button_label . '</button>
                  </div>';
          }
          echo '</div>';
      }
